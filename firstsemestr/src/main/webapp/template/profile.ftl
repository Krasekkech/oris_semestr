...
<#--                            <tr><td>id</td> <td><input type="text" id="id" name="id" value="${clientid!""}"></td></tr>-->
                            ...
                            <tr><td>Пожелания:</td> <td><input type="text" id="userinfo" name="userinfo" placeholder="add"></td></tr>
            ...
            <tr><td>
                    <table>
<#--                        style="display: flex; justify-content: center; width: 25%; margin-left:84px-->
                        <tr><td>id</td> <td>${clientid!""}</td></tr>
                        <input  style="display: none" type="text" id="clientprofile" name="clientprofile" value=${clientprofile}>
                        <input style="display: block" type="text" id="clientfriends" name="clientfriends" value=${clientfriends!""}>
                        <input style="display: none" type="text" id="clientusername" name="clientusername" value=${clientusername!""}>
<#--                        <input  style="display: block" type="text" id="clientprofile" name="clientprofile" value=${clientprofile}>-->
<#--                        <span id="clientusername">${clientusername!""}</span>-->
                        <tr><td>Друзья:</td></tr>
